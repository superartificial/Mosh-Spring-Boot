...
public class AuthController {
    ...
    ResponseEntity<JwtResponse> login(
        ...
        return ResponseEntity.ok( new JwtResponse(accessToken.toString()) ); // don't need build because we're putting an object in the body of the response, not a primitive
    }
